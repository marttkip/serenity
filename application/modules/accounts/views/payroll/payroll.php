...
if ($query->num_rows() > 0)
{
	...
	//gross
	$result .= '
			<th class="center-align" style="text-decoration:underline">'.number_format($total_gross, 2, '.', ',').'</th>
			<th class="center-align" style="text-decoration:underline">'.number_format($total_paye, 2, '.', ',').'</th>
			<th class="center-align" style="text-decoration:underline">'.number_format($total_nssf, 2, '.', ',').'</th>
			<th class="center-align" style="text-decoration:underline">'.number_format($total_nhif, 2, '.', ',').'</th>
			<th class="center-align" style="text-decoration:underline">'.number_format($total_life_ins, 2, '.', ',').'</th>
				<td></td>
	';
	
	$result .= '
				<th class="center-align" style="text-decoration:underline">'.number_format($total_savings, 2, '.', ',').'</th>
				<th class="center-align" style="text-decoration:underline">'.number_format($total_loans, 2, '.', ',').'</th>
				<th class="center-align" style="text-decoration:underline">'.number_format($total_net, 2, '.', ',').'</th>
			</tr>
	';
